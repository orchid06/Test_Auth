                            ...
                            <div class="mt-1 d-flex justify-content-between align-items-center">
                                <form action="{{ route('admin.search') }}" method="get">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="Search product" name="search" id="search" style="width: 800px;">
                                            ...
                                            <div class="container">
                                                <div class="row">
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="type" id="percentage" value="0">
